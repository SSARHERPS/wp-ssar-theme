...
//adds current taxonomy to breadcrumbs
 function ssar_cp_species_breadcrumbs() {
	...
	echo '<div class="breadcrumb"><a href="'.get_bloginfo('url').'">Home</a> &#8594; ' . '<a href="'.get_bloginfo('url').'/?post_type=species-name">North American Checklist</a> &#8594; ' . $term->name .'</div>';
...
//need to create taxonomy by alphabet
...
function start_new_letter($letter) {
		...
		//	$term = get_queried_object();
			...
			/*  echo '<a title="Link to taxa that start with '. $letter .'" href="http://localhost/ssarherps/?taxa='.strtolower($term->name) .'&amp;by_alpha='.$letter.'">'.$letter.'</a>&nbsp;&nbsp;&nbsp;'; 
				*/
